<%@ Page Title="Hygiene Check - 08 February 2024" Language="C#" MasterPageFile="~/CheckCluster.Master" AutoEventWireup="true" CodeBehind="Room2.aspx.cs" Inherits="HygieneCheck.Room2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="RoomContent" runat="server">
    <div class="box">
        <div class="nav">
            <a class="nav-button-inactive" href="Room1">Room 1</a><a class="nav-button-active" href="Room2">Room 2</a><a class="nav-button-inactive" href="Room3">Room 3</a><a class="nav-button-inactive" href="Room4">Room 4</a><a class="nav-button-inactive" href="Room5">Room 5</a><a class="nav-button-inactive" href="Room6">Room 6</a><a class="nav-button-inactive" href="CommonArea">Common Area</a>
        </div>
    </div>
    <div class="green-label">Hygiene record for cluster A-2L room 2 has been submitted.</div>

    <div>
        <div>
            <h4 style="display:inline-block">Bed 2A</h4>
        </div>
        <div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Desk 2A</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Bed 2B</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Desk 2B</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Bed 2C</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Desk 2C</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Bed 2D</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">Desk 2D</h4>
        </div>
    ...
    <div>
        <div>
            <h4 style="display:inline-block">General Cleanliness Room 2</h4>
        </div>
    ...
    <input type="submit" class="center-button" value="Submit A-2L Room 2 Hygiene Record" />
